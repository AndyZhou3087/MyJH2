...
extern "C"
{
    static bool getCCommonMethod(JniMethodInfo &mi, const char *methodName, const char *signature) {
        return JniHelper::getStaticMethodInfo(mi, "com/umeng/common/UMCocosConfigure", methodName, signature);
    }
    ...
    JNIEXPORT void JNICALL Java_com_umeng_common_UMCocosConfigure_InitCC(JNIEnv *env, jclass clz) {
        // initwrap();
        ...
        jmethodID mid = env->GetStaticMethodID(strClass, "initCocos",

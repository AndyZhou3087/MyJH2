...
"密探：\n报告帮主，十四天书在剑南山现世，正魔两派高手已赶往天书出世地抢夺天书。",//3
"少帮主：\n父亲，我愿一同前去为夺书出力。",//4
"帮主：\n好，速召集高手，立即出发！十四天书，决不能落入宵小之手！", //5
"",//6 星级界面
"",//7 缩放引导
"",//8 找到BOSS高亮引导
...
"",//10
"", //11
"小师妹：师兄切莫悲伤，老帮主虽恐遭不测，但我们不可放弃，天书亦决不能落入宵小之人手中。我们广纳豪杰，才好寻回老帮主和天书，客栈中经常会有江湖侠客停留，师兄可前往招募。",//12
"",//13
"小师妹：点击银两刷新按钮，可以刷新可招募的侠客，最高可刷新出红色品质的侠客哦！（侠客的品质由低到高依次为绿，蓝，紫，橙，红）",//14
//这里是否需要滑动引导
//后山引导（改为条件引导）
"小师妹：经营门派最重要的还是要先把基础设施完善起来，我们先去后山看看有什么资源吧!",//15
"小师妹：这里后山还真是什么都没有啊，师兄，先升级一下后山，解锁更多的资源吧！",//16
"",//17
"小师妹：资源有了，我们该招点工人来干活了。",//18
"",//19
"小师妹：工人有了，但是师兄你要分配给他们任务，每个工人采集资源都会消耗一定的食材，记得要保证平衡哦！",//20
"",//21
...
"小师妹：掌门师兄回来啦！现在完成了任务，去议事厅看看可以领取任务奖励哦！",//55
"",//56
"",
"",//58
"小师妹：完成了一个任务，我们可以进行下一个任务了，随着任务的完成会解锁更多的地图，同时也可以获得更多的奖励哦！",//59
"",//60
"",//61
"小师妹：除了主线任务以外，还有支线和每日任务可以做，根据任务不同获得的奖励也有不同，记得每日都完成任务哦！",//62

//条件引导
//医馆
"小师妹：有角色在战斗中死亡了，不过没关系，我们去医馆找医生给他治疗就可以复活了。",//63
"",//64
"小师妹：角色都已经恢复了，可以重新参加战斗了。",//65
...
//铁匠铺//73
"小师妹：掌门师兄回来啦！我们现在有了一定的资源，掌门可以去铁匠铺看看能造些什么东西。",//73
"小师妹：我们打造一把青铜刀试一下，铁匠铺的等级越高，就会有更高的几率造出更好品质的武器哦。",//74
"",//制造75
"",//76
//这里是否需要滑动引导
"小师妹：既然造出来的青铜刀，就给侠客装备上吧！",//77
"",//78
"",
"",
"",
...
"",
"",//84
"小师妹：每个角色转职后都会有不同的职业特性，转职后也会有属性的提升，记得一定要帮助侠客们转职哦！",//85

//回城卷轴
"小师妹：师兄，我们要赶快回到帮派里，刚好这里有道士的回城卷轴，师兄快用一下吧！",//86
"",

//点击仓库 体力不足引导 去掉（改为英雄招募用）
...
void NewGuideLayer::showNextGuide()
{
	...
	else if (m_step == 5)
	{
		...
		|| m_step == 91 || m_step == 92 || m_step == 93 || m_step == 25 || m_step == 27 || m_step == 29)
	{
		this->removeFromParentAndCleanup(true);
		g_NewGuideLayer = NULL;
	}
